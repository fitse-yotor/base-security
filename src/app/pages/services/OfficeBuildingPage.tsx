...
export default function OfficeBuildingPage() {
  const { officeBuildingPage: p } = useCMSStore();
  return (
    <div>
      <section className="relative bg-secondary text-white py-20">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-2 mb-4"><Building2 className="w-8 h-8 text-primary" /><span className="text-primary uppercase tracking-wider text-sm">Corporate Security</span></div>
              <h1 className="text-4xl md:text-5xl mb-6">{p.heroTitle}</h1>
              <p className="text-xl text-gray-200 mb-8">{p.heroSubtitle}</p>
              <Link to="/request-service"><Button size="lg" className="bg-primary hover:bg-primary/90">Request Security Assessment</Button></Link>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12"><h2 className="text-3xl md:text-4xl mb-4">Security Services</h2></div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12"><h2 className="text-3xl md:text-4xl mb-4">Security Packages</h2></div>
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">Get a free security assessment and custom proposal for your facility.</p>
          <Link to="/request-service"><Button size="lg" variant="secondary" className="bg-white text-secondary hover:bg-gray-100">Request Free Assessment</Button></Link>
        </div>
      </section>
    </div>
  );
